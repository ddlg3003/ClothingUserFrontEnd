            ...
            <div className={classes.profileNav}>
              <Stack direction="column">
                ...
                <List sx={style} component="nav">
                  <ListItem
                    button
                    onClick={() => handleNavSelectionChange("profile")}
                  >
                    <ListItemIcon>
                      <PersonIcon />
                    </ListItemIcon>
                  ...
                  <ListItem
                    button
                    divider
                    onClick={() => handleNavSelectionChange("address")}
                  >
                    <ListItemIcon>
                      <EditLocationAltIcon />
                    </ListItemIcon>
                  ...
                  <ListItem
                    button
                    onClick={() => handleNavSelectionChange("changePassword")}
                  >
                    <ListItemIcon>
                      <LockIcon />
                    </ListItemIcon>
            ...
            <Paper elevation={10}>
              <div className={classes.profileMain}>
                <div hidden={navSelection !== "profile"}>
                  <div className={classes.title}>Hồ sơ của tôi</div>
                  <Divider />
                  <Stack
                    direction="row"
                    spacing={20}
                      ...
                      >
                        ...
                        <Grid item xs={8}>
                          <TextField
                            ...
                            helperText={
                              emailValid === false ? "Email không hợp lệ!" : " "
                            }
                          />
                        </Grid>
                        <Grid item xs={4}>
